...
data class SubsProductBean(
    ...
    var month_price: Float? = 0f,
    var quarter_price: Float? = 0f,
    var half_year_price: Float? = 0f,
    var year_price: Float? = 0f,
    var two_year_price: Float? = 0f,
    var three_year_price: Float? = 0f,
    var onetime_price: Float? = 0f,
    var reset_price: Float? = 0f,
