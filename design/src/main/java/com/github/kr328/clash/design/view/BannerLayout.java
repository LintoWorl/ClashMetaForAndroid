...
public class BannerLayout extends RelativeLayout {
    ...
    private boolean isBeginPagerChange = false;
    ...
    private class OnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageSelected(int position) {
            if (!isCyclic) {
                if (changeCallback != null) {
                    changeCallback.onPageSelected(position);
                }
                if (indicator != null) {
        ...
        public void onPageScrollStateChanged(int state) {
            if (isCyclic && state == ViewPager2.SCROLL_STATE_DRAGGING) {
     ...
     */
    public BannerLayout setPageMargin(int multiWidth, int pageMargin) {
     ...
     * @param pageMargin item与item之间的宽度
     */
    public BannerLayout setPageMargin(int tlWidth, int brWidth, int pageMargin) {
    ...
    public BannerLayout addPageTransformer(ViewPager2.PageTransformer transformer) {
        compositePageTransformer.addTransformer(transformer);
        return this;
    }

    public BannerLayout setAutoTurningTime(long autoTurningTime) {
        this.autoTurningTime = autoTurningTime;
        return this;
    }

    public BannerLayout setOuterPageChangeListener(ViewPager2.OnPageChangeCallback listener) {
        this.changeCallback = listener;
        return this;
    }

    public BannerLayout setOffscreenPageLimit(int limit) {
     ...
     * 设置viewpager2的切换时长
     */
    public BannerLayout setPagerScrollDuration(long pagerScrollDuration) {
     ...
     */
    public BannerLayout setOrientation(@ViewPager2.Orientation int orientation) {
        viewPager2.setOrientation(orientation);
        return this;
    }

    public BannerLayout addItemDecoration(@NonNull RecyclerView.ItemDecoration decor) {
        viewPager2.addItemDecoration(decor);
        return this;
    }

    public BannerLayout addItemDecoration(@NonNull RecyclerView.ItemDecoration decor, int index) {
        viewPager2.addItemDecoration(decor, index);
        return this;
    }

    public BannerLayout setCyclic(boolean cyclic) {
        isCyclic = cyclic;
        return this;
    }
     ...
     * 是否自动轮播 大于1页轮播才生效
     */
    public BannerLayout setAutoPlay(boolean autoPlay) {
        isAutoPlay = autoPlay;
    ...
    public BannerLayout setIndicator(Indicator indicator) {
     ...
     */
    public BannerLayout setIndicator(Indicator indicator, boolean attachToRoot) {
     ...
     * 设置banner圆角
     */
    public BannerLayout setRoundCorners(final float radius) {
